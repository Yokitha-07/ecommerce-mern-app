import React, { useEffect, useState } from 'react'; import Slider from 'react-slick';
import { API } from '../api';
import DealsSection from '../components/DealsSection'; import "slick-carousel/slick/slick.css";
import "slick-carousel/slick/slick-theme.css";

export default function Home() { const [ads, setAds] = useState([]);
useEffect(() => {
